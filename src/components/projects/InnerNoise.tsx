    ...
    <div className={"text-left"}>
      ...
      <div className={"p-2"}>
        <p className={"mb-5 mt-5"}>
          ...
          contribution to this shift—a space for exploring the stories behind
          the artists.
        </p>
        <p className={"mb-5"}>
        ...
        <p className={"mb-5 mt-5"}>
          ...
          UK's most renowned orchestras and ensembles, including the BBC
          Scottish Symphony Orchestra, Scottish Chamber Orchestra, London
          @innernoisepod Philharmonic Orchestra, BBC Philharmonic Orchestra, and
          Royal Northern Sinfonia as well as Scottish Ballet Orchestra, where
          she holds the position of Principal Second Violin. She has toured
          internationally, bringing her music to audiences in concert halls
          across Asia, South America, and Europe. She is a lecturer in the
          Strings faculty at the Royal Conservatoire of Scotland, where she is
          passionate about nurturing the next generation of musicians with a
          holistic and thoughtful approach.
        </p>
        <p className={"mb-5"}>
          Looking ahead, she will be mentoring young musicians through exciting
          upcoming projects with the National Youth Orchestra of Scotland and
          the Benedetti Foundation. We’ll discuss her early life, growth
          mindset, evolving career, and an exciting future project.
        </p>
        <p>
